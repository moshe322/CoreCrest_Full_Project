...
.login-card{background:rgba(255,255,255,.96);border-radius:25px;padding:25px;max-width:340px;margin:auto;box-shadow:0 25px 60px rgba(0,0,0,.3);}
.info-box{background:rgba(255,255,255,.16);color:white;border-radius:30px;padding:55px;backdrop-filter:blur(12px);box-shadow:0 25px 60px rgba(0,0,0,.28);border:1px solid rgba(255,255,255,.25);width:100%;min-height:84vh;display:flex;flex-direction:column;justify-content:center;}
.brand-title{font-size:48px;font-weight:800;}
.feature-box{background:rgba(255,255,255,.18);border-radius:18px;padding:16px;margin-top:16px;}
.logo{width:110px;}
...
<p class="text-muted small-text">Enter email and password</p>
</div>
